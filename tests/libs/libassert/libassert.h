...
/*   Updated: 2024/10/30 13:57:41 by ywakamiy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ASSERT_EQ_MALLOC_SIZE(x, y) ASSERT_EQ_MALLOC_SIZE(x, y, __FILE__,
	__func__, __LINE__)
# define ASSERT_EQ_MEM(x, y, z) ASSERT_EQ_MEM(x, y, z, __FILE__, __func__,
	__LINE__)
